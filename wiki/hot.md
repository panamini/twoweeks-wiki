...
- Cover-letter quality PR1 is open as <https://github.com/panamini/neyssan/pull/230>; PR2 is open as <https://github.com/panamini/neyssan/pull/231> and targets only the legacy cover-letter prompt path. PR3 should stay scoped to premium prompt V2, Mistral first, with a flag and baseline.
