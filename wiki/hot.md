...
- MCP / ChatGPT App SDK: PR87.14B is merged as local/dev-only MCP auth discovery and challenge endpoint wiring after PR87.14A auth orchestration, PR87.13 auth metadata/policy, PR87.12 fixture-only local/dev demo, PR87.11 auth/account-linking architecture, and PR87.10 reachability. PR87.8 remains blocked for production exposure. PR80B manual handoff is implemented and remains the safe delivery boundary; production MCP endpoints, production `tools/list`/`tools/call`, real Stytch/OAuth runtime, real handlers, live submit/apply, approved-answer copy, billing, PR88, and PR89 remain blocked.
...
- PR87.14B wires auth discovery/challenge into the local/dev fixture endpoint only; PR87.8 is still blocked for production exposure; real Stytch verification, OAuth callback/token exchange, production MCP, and future launch-readiness need separate reviewed gates.
...
- MCP / ChatGPT App SDK: [[product/chatgpt-app-sdk-roadmap]], [[product/manual-application-handoff]], [[sources/2026-06-24-pr87-14b-mcp-auth-dev-endpoint-wiring-checkpoint]], [[sources/2026-06-24-pr87-14a-mcp-auth-request-orchestrator-checkpoint]], [[sources/2026-06-24-pr87-13-mcp-auth-policy-boundary-checkpoint]], [[sources/2026-06-24-pr87-12-mcp-dev-fixture-demo-checkpoint]], [[sources/2026-06-24-pr87-11-mcp-auth-account-linking-architecture-checkpoint]], [[sources/2026-06-24-pr87-10-mcp-dev-endpoint-blocked-reachability-checkpoint]], [[sources/2026-06-23-release-orchestration-staging-pr87-8-checkpoint]]
