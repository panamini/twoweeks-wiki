...
- PR87.15B0 adds the canonical MCP account-link storage/index contract; PR87.8 is still blocked for production exposure; runtime verifier wiring, OAuth callback/token exchange, production MCP, and future launch-readiness need separate reviewed gates.
...
- 2026-06-25: Recorded `MCP_ACCOUNT_LINK_CANONICAL_STORAGE_PR87_15B0_CHECKPOINT`: PR258 merged the canonical MCP account-link storage/index contract as head `7c6ccc30c55334570da2da3d279f13920033a915` and merge commit `06a76a0b5f87f0d30c24635c436cfe3ffa80b29a`; focused Convex account-link tests passed 24/24, full local-MCP suite passed 59 files / 1377 tests, TypeScript, targeted ESLint, build, Fallow, and diff checks passed; final lookup adapter, endpoint wiring, runtime verifier wiring, production MCP, real OAuth/Stytch runtime calls, account-link mutation, real handlers, live submit/apply, billing, PR88, and PR89 remain blocked.
