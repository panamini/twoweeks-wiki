...
- Cover-letter quality: PR230-PR245, PR246, and PR248 are merged. PR248 tightened the Mistral V2 no-CV candidate-history boundary and reports `READY_FOR_STAGED_INTERNAL_MISTRAL_V2_EXPANSION`; the next step is post-merge verification from `2fd7ebef142859fb089bf8e9d270bf6b5b590fa1`, then staged internal Mistral V2 expansion/evidence gate if clean. Canonical page: [[tasks/2026-06-22-cover-letter-quality-production-roadmap]].
...
- Cover-letter quality PR248 is merged. It must not enable Mistral V2 by default, quality repair, Qwen premium behavior, MCP/App SDK tooling, OAuth, manual handoff, or launch-gate work.
