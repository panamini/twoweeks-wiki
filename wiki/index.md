...
| [[product/chatgpt-app-sdk-roadmap\|ChatGPT/App SDK Roadmap]] | MCP/App SDK PR87.15D merged local/dev runtime auth composition wiring after PR87.15C composition, PR87.15B1 lookup, PR87.15B0 storage, and PR87.15A verifier boundaries; production MCP/OAuth/account-link lifecycle/real handlers remain blocked, with PR88/PR89 still separate from cover-letter work | current | chatgpt-app, apps-sdk |
...
- **Pages actives** : 151 (5 overview, 1 entité, 2 concepts, 8 design, 9 product, 3 strategy, 3 meta, 91 sources, 14 tech, 7 howto, 6 tasks, 2 outputs)
- **Pages archivées** : 2
- **Sources dans `raw/`** : 91
