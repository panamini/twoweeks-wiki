...
| [[product/chatgpt-app-sdk-roadmap\|ChatGPT/App SDK Roadmap]] | PR313-PR316 are merged through current target bbd96b5c; public no-credential smoke is green, while digest deployment migration and fresh authenticated ChatGPT proof remain not done | current | chatgpt-app, apps-sdk |
...
Cover-letter quality now includes merged PR310 deterministic replay and PR312 multilingual policy shadow. Replay shares production preparation/finalization and defaults to zero provider calls; the shadow baseline is 84 records / 70 plans / 14 rejections with 13 distant non-English plans still unanchored. The fixtures are currently English-only, so production cutover, broad multilingual quality claims, full production GO, and quality repair remain separate/not approved. The MCP/App SDK track is merged through PR316 at current target `bbd96b5cbaa3f7a24908ed51b001183b62119001`. The canonical private-beta eligibility key uses lowercase SHA-256 subject digests, and the fresh credential-free public canary is green across metadata, both protocol versions, exact six-tool inventory, and fail-closed negative paths. Deployment env migration to the digest key and fresh authenticated ChatGPT proof after migration remain not done. Provider calls, write actions, refresh tokens, production account-link lifecycle expansion, non-beta access, and public launch remain blocked; PR80B remains the safe manual handoff path while ATS authorization is pending.

| Page | Type | Date | Status |
|------|------|------|--------|
| [[sources/2026-07-13-pr313-pr316-mcp-private-beta-readiness-checkpoint\|PR313-PR316 MCP Private-beta Readiness Checkpoint]] | checkpoint | 2026-07-13 | current |
...
| Page | Résumé | Tags |
|------|--------|------|
| [[howto/chatgpt-mcp-private-beta-tunnel-connector\|ChatGPT MCP Private Beta Tunnel Connector Runbook]] | Demarrage reproductible du tunnel nomme, source Infisical du secret partage, synchronisation protegee sous xtrace et preuve ChatGPT MCP read-only | chatgpt-app, mcp, cloudflare, infisical |
...
| [[tasks/2026-06-22-cover-letter-quality-production-roadmap|Cover Letter Quality Production Roadmap]] | PR310 replay and PR312 multilingual policy shadow are merged; French/non-Latin replay evidence, 13 unanchored distant-language rows, transactional reliability, editorial review, production cutover, and quality repair remain gated |
