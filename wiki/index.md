...
| [[product/chatgpt-app-sdk-roadmap\|ChatGPT/App SDK Roadmap]] | MCP/App SDK PR87.14A merged auth request orchestrator boundary; production MCP/OAuth/real handlers remain blocked, with PR88/PR89 still separate from cover-letter work | current | chatgpt-app, apps-sdk |
...
- **Pages actives** : 149 (5 overview, 1 entité, 2 concepts, 8 design, 9 product, 3 strategy, 3 meta, 89 sources, 14 tech, 7 howto, 6 tasks, 2 outputs)
- **Pages archivées** : 2
- **Sources dans `raw/`** : 91
