...
| [[product/chatgpt-app-sdk-roadmap\|ChatGPT/App SDK Roadmap]] | MCP/App SDK PR304 live connector smoke merged; PR305 durable mcp.twoweeks.ai proof is draft with local Clerk/stale-cookie blockers fixed and final ChatGPT UI activation blocked before `/oauth/token` | current | chatgpt-app, apps-sdk |
...
| Page | Résumé | Tags |
|------|--------|------|
| [[howto/chatgpt-mcp-private-beta-tunnel-connector\|ChatGPT MCP Private Beta Tunnel Connector Runbook]] | Demarrage reproductible du tunnel nomme, configuration OAuth confidentielle, rotation secret/digest et preuve ChatGPT MCP read-only | chatgpt-app, mcp, cloudflare |
