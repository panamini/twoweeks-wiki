...
| [[product/chatgpt-app-sdk-roadmap\|ChatGPT/App SDK Roadmap]] | MCP/App SDK PR304 live connector smoke merged after PR303 post-merge proof and PR302 Stage 3 read-side materialization | current | chatgpt-app, apps-sdk |
...
| Page | Résumé | Tags |
|------|--------|------|
| [[howto/chatgpt-mcp-private-beta-tunnel-connector\|ChatGPT MCP Private Beta Tunnel Connector Runbook]] | Procedure manuelle en francais pour creer le tunnel Cloudflare quick tunnel, configurer le connecteur ChatGPT OAuth prive, et verifier le smoke MCP read-only | chatgpt-app, mcp, cloudflare |
