...
| [[product/chatgpt-app-sdk-roadmap\|ChatGPT/App SDK Roadmap]] | MCP/App SDK PR87.15C merged the non-production auth composition boundary after PR87.15B1 lookup, PR87.15B0 storage, and PR87.15A verifier boundaries; production MCP/runtime wiring/OAuth/real handlers remain blocked, with PR88/PR89 still separate from cover-letter work | current | chatgpt-app, apps-sdk |
